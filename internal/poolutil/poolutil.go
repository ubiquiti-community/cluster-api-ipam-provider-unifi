...
func ListAddressesInUse(ctx context.Context, c client.Client, namespace, poolName, poolKind, poolAPIGroup string) ([]ipamv1.IPAddress, error) {
...
func computeAddressUsage(poolIPSet *netipx.IPSet, addressesInUse []ipamv1.IPAddress, poolNamespace string) (used, outOfRange int) {
