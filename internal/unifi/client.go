...
func (c *Client) GetOrAllocateIP(ctx context.Context, networkID, macAddress, hostname string, poolSpec *ipamv1beta2.SubnetSpec, addressesInUse []ipamv1.IPAddress) (*IPAllocation, error) {
...
func (c *Client) allocateNextIP(_ *unifi.Network, subnetSpec *ipamv1beta2.SubnetSpec, addressesInUse []ipamv1.IPAddress) (string, error) {
	if subnetSpec == nil {
